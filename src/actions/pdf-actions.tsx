    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.coverPage}>
        ...
        <Text style={styles.subtitle}>
          {data.trim || "Standard Specification"}
        </Text>
        ...
        <View style={{ flexDirection: "row", gap: 20 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={styles.row}>
              <Text style={styles.colLabel}>Target Market</Text>
              <Text style={styles.colValue}>{data.countryOfOrigin}</Text>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.colValue}>{data.emissions || "-"}</Text>
            </View>
            ...
            <View style={styles.row}>
              <Text style={styles.colLabel}>Upholstery</Text>
              <Text style={styles.colValue}>{data.upholstery || "-"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.colLabel}>Infotainment</Text>
              <Text style={styles.colValue}>{data.infotainment || "-"}</Text>
            </View>
          </View>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={styles.row}>
              <Text style={styles.colLabel}>Engine</Text>
              <Text style={styles.colValue}>{data.engineConfig || "-"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.colLabel}>Displacement</Text>
              <Text style={styles.colValue}>{data.displacement || "-"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.colLabel}>Power</Text>
              <Text style={styles.colValue}>{data.maxPower || "-"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.colLabel}>Torque</Text>
              <Text style={styles.colValue}>{data.maxTorque || "-"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.colLabel}>Transmission</Text>
              <Text style={styles.colValue}>{data.transmission || "-"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.colLabel}>Fuel</Text>
              <Text style={styles.colValue}>{data.fuelSystem || "-"}</Text>
            </View>
          </View>
        </View>
...
export async function generateDossierPdfAction(id: string) {
  try {
    ...
    // Name file cleanly
    const fileName =
      `${dossierData.make}_${dossierData.model}_Blueprint.pdf`.replace(
        /\s+/g,
        "_",
      );
