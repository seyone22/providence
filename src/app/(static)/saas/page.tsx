...
export default function SaaSSignup() {
  ...
  return (
    <main className="min-h-screen bg-white text-black relative font-sans overflow-x-hidden selection:bg-black/10 selection:text-black">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 top-0 h-[760px] z-0 overflow-hidden"
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 pt-40">
        ...
        <div className="text-center mb-32 max-w-4xl mx-auto">
          ...
          >
            The ultimate B2B sourcing software. Fulfill customer inquiries
            faster, manage global orders seamlessly, and leverage AI to find the
            perfect vehicles.
          </Reveal>
        </div>
        ...
        >
          <h2 className="text-red-500 font-bold tracking-[0.2em] uppercase text-sm mb-6">
            The Bottleneck
          </h2>
          <h3 className="text-3xl md:text-4xl font-bold mb-6 text-black tracking-tight">
            Manual sourcing doesn't scale.
          </h3>
          <p className="text-zinc-500 text-lg md:text-xl leading-relaxed font-light">
            Tracking shipments on spreadsheets, checking dozens of international
            sites, and manually calculating import taxes is a barrier to your
            growth. It's time to let software do the heavy lifting.
          </p>
        </Reveal>
                ...
                >
                  ...
                  >
                    <div className="relative z-10 flex items-center gap-5 mb-3">
                      <div
                        className={`p-3 rounded-2xl transition-colors duration-300 ${activeTab === idx ? "bg-black text-white" : "bg-black/10 text-black"}`}
                      >
                        {feature.icon}
                      </div>
                    ...
                    <p className="text-zinc-500 text-lg font-light leading-relaxed pl-[4.5rem] relative z-10">
                      {feature.desc}
                    </p>
                  </button>
                </Reveal>
        ...
        >
          ...
          <p className="text-zinc-500 text-lg md:text-xl font-light mb-12 max-w-2xl mx-auto">
            Technology is moving fast. Dealerships using our SaaS tool are
            fulfilling orders in days, while traditional dealers spend weeks
            making calls. Stop artificially capping your revenue.
          </p>

          <Link
            href="/signup"
            className="group inline-flex items-center justify-center gap-3 bg-black text-white px-10 py-5 rounded-full text-xl font-bold hover:scale-105 shadow-[0_10px_40px_rgba(0,0,0,0.15)] transition-all duration-300"
          >
