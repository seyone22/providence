            ...
            <section className="py-32 px-6 max-w-7xl mx-auto bg-white relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16">
                    {[
                        ...
                        { icon: Ship, title: "White-Glove Logistics", desc: "From the 100+ global markets to your country. We handle every single form, marine insurance policy, and freight mile for you. Zero friction.", glowColor: "group-hover:bg-indigo-500/15" },
