    ...
    <main className="min-h-screen bg-white text-black selection:bg-black/10 selection:text-black font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center px-6 pt-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto flex flex-col items-center mt-12">
          ...
          >
            <Link
              href="/request"
              className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-black rounded-full overflow-hidden transition-transform hover:scale-105 shadow-[0_10px_40px_rgba(0,0,0,0.1)]"
            >
              <span className="relative z-10">Request a Car Now</span>
            </Link>
            <Link
              href="/saas"
              className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-black bg-white border border-black/10 rounded-full backdrop-blur-xl transition-all hover:bg-black hover:text-white shadow-md"
            >
      ...
      <section className="py-32 md:py-48 px-6 bg-zinc-50 relative border-y border-black/5">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            We act as your{" "}
            <span className="text-black drop-shadow-sm">Virtual Warehouse</span>
            , giving your dealership the inventory power of a global
            conglomerate. Access over{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 auto-rows-[280px]">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-black mb-2 relative z-10">
              Sell Beyond Your Lot
            </h3>
            <p className="text-zinc-500 text-lg relative z-10 font-light">
              You sell cars you don't physically have. Borderless inventory.
            </p>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-black mb-2 relative z-10">
              The Hard Part, Prepared
            </h3>
            <p className="text-zinc-500 text-lg relative z-10 font-light">
              Bill of Lading, HS codes and marine cover — prepared, filed and
              explained.
            </p>
            <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-black/5 rounded-full blur-[80px] group-hover:bg-blue-600/10 transition-colors duration-500" />
          </Reveal>
          ...
          >
            ...
            <p className="text-zinc-500 text-lg relative z-10 font-light">
              Your custom-branded dashboard keeps everything tracked.
            </p>
            <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-black/5 rounded-full blur-[80px] group-hover:bg-blue-600/10 transition-colors duration-500" />
          </Reveal>
      ...
      <section className="relative py-32 px-6 flex justify-center border-t border-black/5 bg-zinc-50 overflow-hidden">
        ...
        <Reveal y={40} scale={0.95} duration={1} className="relative z-10">
          <Link href="/saas" className="group flex flex-col items-center">
            <p className="text-zinc-400 font-medium mb-4 group-hover:text-black transition-colors">
              Ready to scale?
            </p>
