...
const BRANDS: { name: string; make: string; image: string }[] = [
  {
    name: "Rolls-Royce",
    make: "Rolls-Royce",
    image: IMG("1625510872834-7db6c4273870"),
  },
  {
    name: "Bentley",
    make: "Bentley",
    image: IMG("1725181952127-93be5d418102"),
  },
  {
    name: "Ferrari",
    make: "Ferrari",
    image: IMG("1614200187524-dc4b892acf16"),
  },
  {
    name: "Lamborghini",
    make: "Lamborghini",
    image: IMG("1596125099792-3917bf2d8095"),
  },
  {
    name: "Aston Martin",
    make: "Aston Martin",
    image: IMG("1608340821332-3a73fadd890c"),
  },
  {
    name: "McLaren",
    make: "McLaren",
    image: IMG("1617335692042-7a3779b8e050"),
  },
  {
    name: "Bugatti",
    make: "Bugatti",
    image: IMG("1698669632639-76229771a1a9"),
  },
  {
    name: "Porsche",
    make: "Porsche",
    image: IMG("1611651338412-8403fa6e3599"),
  },
  {
    name: "Mercedes-Benz",
    make: "Mercedes-Benz",
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto flex flex-col items-center mt-0">
          ...
          >
            <span className="flex items-center gap-2">
              <ShieldCheck size={16} className="text-black" /> Genuine factory
              LHD
            </span>
            <span className="flex items-center gap-2">
              <Gauge size={16} className="text-black" /> Grade-verified auctions
            </span>
            <span className="flex items-center gap-2">
              <Globe2 size={16} className="text-black" /> Landed worldwide
            </span>
          </Reveal>
      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-zinc-500 font-light max-w-2xl mx-auto">
            Your dream in{" "}
            <span className="text-black font-medium">left-hand drive</span> —
            we'll source the exact spec from Japan and come back with a full
            landed-cost quote before you commit.
          </p>
        </Reveal>
