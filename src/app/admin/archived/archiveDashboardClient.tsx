...
const ARCHIVE_STATUSES = ["Lead Closed", "Lead Lost", "Not Qualified"];

export default function ArchiveDashboardClient({
  requests,
  staffUsers,
  currentUserId,
}: any) {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: filteredRequests.filter((r: any) => r.leadStatus === "Lead Closed")
        .length,
      icon: ThumbsUp,
    ...
    },
    {
      ...
      value: filteredRequests.filter((r: any) => r.leadStatus === "Lead Lost")
        .length,
      icon: ThumbsDown,
    ...
    },
    {
      ...
      value: filteredRequests.filter(
        (r: any) => r.leadStatus === "Not Qualified",
      ).length,
      icon: Users,
    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="bg-white border border-zinc-200/60 p-6 rounded-[2rem] shadow-sm"
          >
