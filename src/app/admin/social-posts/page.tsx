          ...
          {PAGES.map((page) => {
            ...
            return (
              ...
              >
                {page.label}
                <span
                  className={`ml-2 text-xs ${activePage === page.id ? "text-zinc-400" : "text-zinc-400"}`}
                >
                  {count}
                </span>
              </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-zinc-400 text-lg font-light">
              No posts added to {PAGES.find((p) => p.id === activePage)?.label}{" "}
              yet.
            </p>
          </div>
        ) : (
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-between">
                    <div>
                      ...
                      {editingId === post._id ? (
                        ...
                        <div>
                          <p className="text-sm text-zinc-600 font-mono break-all mb-1">
                            {post.url}
                          </p>
                    ...
                    {editingId !== post._id && (
                      <div className="flex items-center gap-2 mt-6 pt-4 border-t border-zinc-100">
                        ...
                        <select
                          value={post.page}
                          onChange={(e) =>
                            handleMovePage(post._id, e.target.value)
                          }
