  ...
  return (
    <>
      <Lead>
        ...
        it&rsquo;s a sequence of legal decisions made in the right order. Get them
        right and you keep customs duty, VAT and VRT as low as the rules allow.
        Get one wrong and a &ldquo;bargain&rdquo; abroad becomes an expensive
        surprise at the Irish port.
      </Lead>

      <KeyTakeaways
        items={[
          <>
            Buy a car that qualifies for <Strong>0% duty</Strong> — and insist on
            the origin document that proves it.
          </>,
          <>
          ...
          <>
            Hit the <Strong>3–8 year / average-mileage</Strong> sweet spot to keep
            OMSP and VRT moderate.
          </>,
          <>
      ...
      <P>
        ...
        That means a single saved charge (like avoiding 10% duty) also reduces the
        VAT charged on top. Every step below is about shrinking one of those three
        numbers legally. If you want the full mechanics first, read{" "}
      ...
      <P>
        ...
        qualifies for 0%. Two origins qualify:{" "}
        <Strong>Japanese-built</Strong> (EU–Japan EPA, since February 2026) and{" "}
        <Strong>UK-built</Strong> (EU–UK TCA). Both need a valid{" "}
        <Strong>Statement of Origin</Strong> from the seller. On a €20,000 landed
        value, that document is worth €2,000 in duty — plus the knock-on VAT
        saving, because VAT is charged on the duty too.
      </P>
      <Callout title="Get it in writing — before you buy" tone="amber">
        <p>
          ...
          built in Japan but bought in Britain still needs that paperwork. Confirm
          it in writing before paying a deposit, not after the car has shipped.
        </p>
      </Callout>
      ...
      <UL>
        ...
        <CheckLI>
          ...
          often come south with no duty <em>and</em> no VAT, because NI is treated
          as EU territory. Revenue scrutinises this, so the ownership must be real.
        </CheckLI>
      </UL>
      <P>
      ...
      <P>
        ...
        transport&rdquo; VAT trap on EU/NI cars, and cars from ~2019 onward carry
        genuine WLTP CO₂ data — avoiding the NEDC-conversion penalty that can push
        an older car up a VRT band.
      </P>
      <Callout tone="sky">
        <p>
          Don&rsquo;t chase ultra-low mileage to look like a bargain — Revenue
          assigns a <em>higher</em> OMSP (and more VRT) to a low-mileage car. The
          cheapest real-world buy is average mileage with documented good
          condition.
        </p>
      </Callout>
      ...
      <P>
        ...
        range. Favour <Strong>petrol or hybrid over diesel</Strong>: diesels carry
        a NOx levy capped at €4,850 (versus €600 for petrol), and an old diesel
        with no documented NOx figure is assessed at the highest assumed rate — a
        common, expensive surprise. The full breakdown is in{" "}
      ...
      <UL>
        ...
        <CheckLI>
          <Strong>Transfer of Residence relief</Strong> — moving to Ireland? A car
          you owned and used abroad for 6+ months can come in free of VRT, VAT and
          duty (it can&rsquo;t be sold for 12 months after).
        </CheckLI>
        <CheckLI>
          <Strong>Appeal the OMSP</Strong> — if Revenue&rsquo;s valuation is
          higher than the car&rsquo;s genuine Irish market value, you can appeal it
          with evidence and reduce the VRT directly.
        </CheckLI>
      </UL>
      <Callout title="A word of caution" tone="amber">
        <p>
          Avoid under-declaring price, mislabelling a passenger car as commercial,
          false origin statements, or staged NI &ldquo;ownership&rdquo;. Revenue
          cross-checks invoices, VINs and shipping records — penalties and seizure
          outweigh any saving. Every relief above is legal when it genuinely
          applies.
        </p>
      </Callout>
      ...
      <P>
        ...
        customs, VRT and registration, which usually protects more than it costs.
        Either way, the golden rule holds: model the full landed cost before you
        bid. Start with our{" "}
