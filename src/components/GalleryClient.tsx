          ...
          <div className="flex overflow-x-auto gap-6 pb-12 snap-x snap-mandatory hide-scrollbar -mx-6 px-6 lg:mx-0 lg:px-0">
            {[
              ...
              },
              {
                name: "Sarah M.",
                date: "1 week ago",
                title: "Incredible communication",
                desc: "I was nervous about importing from Japan, but their weekly updates and detailed inspection reports gave me complete peace of mind.",
              },
              {
                name: "David T.",
                date: "3 weeks ago",
                title: "Exactly as described",
                desc: "The 150-point inspection is no joke. The Defender was exactly as pictured. Will absolutely be using Providence for my next vehicle.",
              },
              {
                name: "Michael H.",
                date: "1 month ago",
              ...
              },
              {
                name: "James L.",
                date: "2 months ago",
                title: "Highly professional outfit",
                desc: "Their market knowledge is unparalleled. They advised me to wait two weeks for a better exchange rate, saving me thousands.",
              },
            ].map((review, i) => (
              <Reveal
                key={i}
          ...
          >
            ...
            <div className="pr-4 md:pr-12 py-4">
              <h3 className="text-2xl md:text-3xl font-bold tracking-tighter mb-4">
                Our review of the 2024 Range Rover
              </h3>
              ...
              <p className="text-zinc-500 font-light leading-relaxed mb-8">
                "The Range Rover needs no introduction. For 50 years it has been
                a staple of luxury, becoming the definition of a premium SUV.
                However, navigating the import market for one requires
                expertise. Here is why importing direct remains the superior
                choice..."
              </p>
              <Link
                href="/request"
