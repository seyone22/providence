...
const TZ_ZONES: TzZone[] = [
  { tz: "Etc/GMT+12", abbr: "AoE", places: "Baker Island, Howland Island" },
  {
    ...
    abbr: "SST",
    places: "American Samoa, Niue, Midway",
  },
  {
    tz: "Pacific/Honolulu",
    abbr: "HST",
    places: "Hawaii (USA), Tahiti, Cook Islands",
  },
  ...
  { tz: "America/Anchorage", abbr: "AKST/AKDT", places: "Alaska (USA)" },
  {
    ...
    abbr: "PST/PDT",
    places: "US Pacific, Canada (Vancouver), Mexico (Tijuana)",
  },
  {
    tz: "America/Denver",
    abbr: "MST/MDT",
    places: "US Mountain, Canada (Edmonton)",
  },
  {
    tz: "America/Phoenix",
    abbr: "MST",
    places: "Arizona (USA), Mexico (Hermosillo)",
  },
  {
    tz: "America/Chicago",
    abbr: "CST/CDT",
    places: "US Central, Canada (Winnipeg)",
  },
  {
    tz: "America/Mexico_City",
    abbr: "CST",
    places: "Mexico, Guatemala, Costa Rica, El Salvador, Honduras",
  },
  {
    tz: "America/New_York",
    abbr: "EST/EDT",
    places: "US Eastern, Canada (Toronto), Cuba, Bahamas",
  },
  {
    tz: "America/Bogota",
    abbr: "COT/PET",
    places: "Colombia, Peru, Ecuador, Panama, Jamaica",
  },
  {
    tz: "America/Halifax",
    abbr: "AST/ADT",
    places: "Canada (Halifax), Bermuda",
  },
  {
    tz: "America/Santo_Domingo",
    abbr: "AST",
    places: "Dominican Rep., Puerto Rico, Venezuela, Bolivia, Guyana",
  },
  ...
  { tz: "America/St_Johns", abbr: "NST/NDT", places: "Newfoundland (Canada)" },
  {
    ...
    abbr: "BRT",
    places: "Brazil (São Paulo, Brasília)",
  },
  {
    tz: "America/Argentina/Buenos_Aires",
    abbr: "ART",
    places: "Argentina, Uruguay, French Guiana",
  },
  {
    tz: "Atlantic/South_Georgia",
    abbr: "GST",
    places: "South Georgia, Fernando de Noronha",
  },
  ...
  { tz: "Atlantic/Cape_Verde", abbr: "CVT", places: "Cape Verde" },
  {
    tz: "Europe/London",
    abbr: "GMT/BST",
    places: "United Kingdom, Ireland, Portugal",
  },
  {
    tz: "Africa/Accra",
    abbr: "GMT",
    places: "Ghana, Senegal, Ivory Coast, Iceland, Mali",
  },
  {
    tz: "Europe/Paris",
    abbr: "CET/CEST",
    places:
      "Germany, France, Spain, Italy, Netherlands, Belgium, Switzerland, Austria, Poland, Sweden, Norway, Denmark, Malta",
  },
  {
    tz: "Africa/Lagos",
    abbr: "WAT",
    places: "Nigeria, Cameroon, Angola, DR Congo (Kinshasa)",
  },
  {
    tz: "Europe/Helsinki",
    abbr: "EET/EEST",
    places: "Finland, Greece, Romania, Ukraine, Cyprus, Bulgaria",
  },
  { tz: "Africa/Cairo", abbr: "EET", places: "Egypt, Libya" },
  {
    tz: "Africa/Johannesburg",
    abbr: "SAST",
    places: "South Africa, Zambia, Zimbabwe, Botswana",
  },
  { tz: "Asia/Jerusalem", abbr: "IST/IDT", places: "Israel, Palestine" },
  {
    tz: "Asia/Riyadh",
    abbr: "AST",
    places: "Saudi Arabia, Kuwait, Qatar, Bahrain, Iraq, Yemen",
  },
  {
    tz: "Africa/Nairobi",
    abbr: "EAT",
    places: "Kenya, Ethiopia, Tanzania, Uganda, Somalia",
  },
  ...
  { tz: "Asia/Tehran", abbr: "IRST", places: "Iran" },
  {
    tz: "Asia/Dubai",
    abbr: "GST",
    places: "UAE, Oman, Azerbaijan, Armenia, Georgia, Mauritius",
  },
  { tz: "Asia/Kabul", abbr: "AFT", places: "Afghanistan" },
  {
    tz: "Asia/Karachi",
    abbr: "PKT",
    places: "Pakistan, Uzbekistan, Turkmenistan, Maldives, Tajikistan",
  },
  ...
  { tz: "Asia/Kathmandu", abbr: "NPT", places: "Nepal" },
  {
    tz: "Asia/Dhaka",
    abbr: "BDT",
    places: "Bangladesh, Bhutan, Kazakhstan (Almaty)",
  },
  { tz: "Asia/Yangon", abbr: "MMT", places: "Myanmar, Cocos Islands" },
  {
    tz: "Asia/Bangkok",
    abbr: "ICT",
    places: "Thailand, Vietnam, Cambodia, Laos, Indonesia (Jakarta)",
  },
  {
    tz: "Asia/Singapore",
    abbr: "SGT/CST/HKT",
    places:
      "Singapore, China, Hong Kong, Taiwan, Malaysia, Philippines, Australia (Perth)",
  },
  {
    tz: "Asia/Tokyo",
    abbr: "JST/KST",
    places: "Japan, South Korea, North Korea",
  },
  {
    tz: "Australia/Darwin",
    abbr: "ACST",
  ...
  },
  {
    ...
    abbr: "AEST",
    places: "Australia – Queensland, Papua New Guinea",
  },
  {
    tz: "Australia/Sydney",
    abbr: "AEST/AEDT",
    places: "Australia – NSW, Victoria, Canberra, Tasmania",
  },
  {
    tz: "Pacific/Guadalcanal",
    abbr: "SBT",
    places: "Solomon Islands, New Caledonia, Vanuatu",
  },
  { tz: "Pacific/Auckland", abbr: "NZST/NZDT", places: "New Zealand" },
  {
    tz: "Pacific/Tarawa",
    abbr: "GILT",
    places: "Kiribati (Gilbert), Marshall Islands, Tuvalu, Nauru, Fiji",
  },
...
export const TIMEZONE_OPTIONS: { tz: string; label: string }[] = TZ_ZONES.map(
  (z) => ({
    tz: z.tz,
...
export function timezoneForCountry(country?: string): {
  ...
  const opt =
    TIMEZONE_OPTIONS.find((o) => o.tz === tz) ||
    TIMEZONE_OPTIONS.find((o) => o.tz === DEFAULT_TZ)!;
 ...
 */
export function contactDueMatches(
  preferredContactAt: string | Date | null | undefined,
  bucket: ContactDueBucket,
): boolean {
