  ...
  return (
    ...
    >
      <Container style={mainBodyStyle}>
        ...
        <Text style={textStyle}>
          We've received your inquiry for the {make} {model} and wanted to let
          you know; it hasn't just gone into a queue. It's already been assigned
          to {staffName}, who'll be your dedicated point of contact from here.
        </Text>
          ...
          <Row>
            ...
            <Column style={textColumnStyle}>
              <Text style={mainSectionHeadingStyle}>
                Before {staffName} gets in touch, we just need one quick step
                from you:
              </Text>
              <Text style={mainSectionTextStyle}>
                Tapping the button below confirms your interest and moves things
                forward on our end. Once authenticated, {staffName} will be in
                touch shortly with the details you need, pricing, availability,
                shipping timelines, and anything else on your mind.
              </Text>
            </Column>
          </Row>
        </Section>
        ...
        <Text style={textStyle}>
          If you have any questions in the meantime, you're welcome to reply
          directly to this email.
        </Text>
        <Text style={textStyle}>We look forward to working with you.</Text>
      ...
      <Section style={footerSectionStyle}>
        <Container>
          <Text style={footerLinkTextStyle}>
            <Link
              href={`${process.env.NEXT_PUBLIC_BASE_URL}/view/${requestId}`}
